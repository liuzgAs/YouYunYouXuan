...
public class WoDeJFActivity extends ZjbBaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<CustomerGetintegral.DataBean>(WoDeJFActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_jifen;
                return new WoDeJFViewHolder(parent, layout);
            }
        });
                ...
                ApiClient.post(WoDeJFActivity.this, getOkObject(), new ApiClient.CallBack() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        try {
                            ...
                            if (status == 1) {
                                List<CustomerGetintegral.DataBean> dataBeanList = customerGetintegral.getData();
    ...
    private OkObject getOkObject() {
        String url = Constant.HOST + Constant.Url.CUSTOMER_GETINTEGRAL;
    ...
    public void onRefresh() {
        ...
        ApiClient.post(this, getOkObject(), new ApiClient.CallBack() {
            ...
            public void onSuccess(String s) {
                ...
                try {
                    ...
                    if (customerGetintegral.getStatus() == 1) {
                        List<CustomerGetintegral.DataBean> dataBeanList = customerGetintegral.getData();
                        GlideApp.with(WoDeJFActivity.this)
                                .load(customerGetintegral.getHeadimg())
                                .centerCrop()
                                .placeholder(R.mipmap.ic_empty)
                                .into(imageHead);
                        textScore.setText(String.valueOf(customerGetintegral.getIntegral()));
                        adapter.clear();
                        adapter.addAll(dataBeanList);
            ...
            private void showError(String msg) {
                try {
                    View viewLoader = LayoutInflater.from(WoDeJFActivity.this).inflate(R.layout.view_loaderror, null);
