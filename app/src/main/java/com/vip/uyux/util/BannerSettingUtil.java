...
public class BannerSettingUtil {
    ...
    public BannerSettingUtil(ViewPager mViewPager_banner, int margin, boolean isScorll) {
    ...
    public void set() {
        mViewPager_banner.setPageMargin(margin);//设置page间间距，自行根据需求设置
...
//        mViewPager_banner.setPageTransformer(true, new ScaleInTransformer(new AlphaPageTransformer()));
    ...
    private void autoScroll(boolean isScorll) {
        if (isScorll) {
