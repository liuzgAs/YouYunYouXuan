 ...
 */
public class DingDanXQItemViewHolder extends BaseViewHolder<UserOrderinfo.DataBean.ListBeanX.ListBean> {
    ...
    public DingDanXQItemViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(UserOrderinfo.DataBean.ListBeanX.ListBean data) {
        super.setData(data);
