...
public class ChanPinLBFragment extends ZjbBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public ChanPinLBFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public ChanPinLBFragment(int id) {
        this.id=id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mInflate == null) {
            mInflate = inflater.inflate(R.layout.fragment_chan_pin_lb, container, false);
            init();
        }
    ...
    private OkObject getOkObject() {
        ...
        params.put("cate", String.valueOf(id));
