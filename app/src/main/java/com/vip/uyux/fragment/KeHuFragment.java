...
import com.vip.uyux.viewholder.KeHuViewHolder;
 ...
 */
public class KeHuFragment extends ZjbBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mInflate == null) {
            mInflate = inflater.inflate(R.layout.fragment_ke_hu, container, false);
            init();
        }
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Customer.DataBean>(mContext) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_kehu;
                return new KeHuViewHolder(parent, layout);
            }
        });
    ...
    private OkObject getOkObject() {
        String url = Constant.HOST + Constant.Url.CUSTOMER;
